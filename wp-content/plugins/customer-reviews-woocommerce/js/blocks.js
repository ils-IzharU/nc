							...
							el(
								...
								[
									...
									el(
										BaseControl,
										{
											id: 'cr_trustbadge_colorpicker',
											className: 'cr-trustbadge-colorpicker',
											...
											children: el(
												...
												{
													id: 'cr_trustbadge_colorpicker',
													color: props.attributes.badge_color,
													disableAlpha: true,
													onChangeComplete: function( color ) {
														props.setAttributes( {
															badge_color: color.hex
														} );
													}
												}
											)
								...
								[
									...
									el(
										ToggleControl,
										{
											...
											checked: props.attributes.show_summary_bar,
											onChange: function() {
												props.setAttributes( {
													show_summary_bar: ! props.attributes.show_summary_bar
												} );
											}
										}
									),

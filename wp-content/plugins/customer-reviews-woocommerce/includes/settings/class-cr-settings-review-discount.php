		...
		*/
		...
		protected function init_settings() {
			...
			$this->settings = array(
				...
				array(
					'title'   => __( 'Allow sharing', 'customer-reviews-woocommerce' ),
					'desc' => __( 'If sharing is allowed, customers will be able to share their coupons with other people. Otherwise, coupons will be valid only for customers who received them.', 'customer-reviews-woocommerce' ),
					'id'      => 'ivole_coupon__sharing',
					'default' => 'no',
					'type'    => 'checkbox'
				),
				array(

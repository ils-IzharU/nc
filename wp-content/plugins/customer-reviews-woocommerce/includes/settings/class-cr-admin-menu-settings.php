...
if ( ! class_exists( 'CR_Settings_Admin_Menu' ) ):
	...
	require_once dirname( dirname( dirname( __FILE__ ) ) ) . '/class-ivole-email.php';
	...
	require_once dirname( dirname( dirname( __FILE__ ) ) ) . '/class-ivole-verified-reviews.php';
		...
		*/
		...
		public function include_scripts() {
			if ( isset( $_REQUEST['page'] ) && $_REQUEST['page'] === 'ivole-reviews-settings' ) {
				wp_enqueue_script( 'cr-admin-settings', plugins_url('js/admin-settings.js', dirname( dirname( __FILE__ ) ) ), array(), false, false );
			}
